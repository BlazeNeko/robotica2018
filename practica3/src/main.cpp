 ...
 *
 * Just: "${PATH_TO_BINARY}/move --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class move : public RoboComp::Application
{
public:
	move (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
int ::move::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
